...
public class UsuarioDAO {
    public List<Usuario> listarUsuarios() {
        ...
        String sql = """
            SELECT u.id, u.nombre, u.edad, u.contrasena, 
    ...
    public List<Usuario> listarUsuariosPaginado(int limit, int offset) {
        List<Usuario> lista = new ArrayList<>();
        String sql = "SELECT u.id, u.nombre, u.edad, u.contrasena, " +
                     "r.codigo AS rol_codigo, r.nombre AS rol_nombre, r.descripcion AS rol_descripcion " +
                     "FROM usuario u " +
    ...
    public boolean insertarUsuario(Usuario u) {
        String sql = "INSERT INTO usuario(id, nombre, edad, rol_codigo, contrasena) VALUES (?, ?, ?, ?, ?)";
        try (Connection conn = Conexion.getConexion();
             PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public void actualizarUsuario(Usuario u) {
        String sql = "UPDATE usuario SET nombre=?, edad=?, rol_codigo=?, contrasena=? WHERE id=?";
        try (Connection conn = Conexion.getConexion();
             PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public Usuario login(String id, String contrasenia) {
        Usuario user = null;
        String sql = """
            SELECT u.id, u.nombre, u.edad, u.contrasena, r.codigo AS rol_codigo, r.nombre AS rol_nombre, r.descripcion AS rol_descripcion\n
                    FROM usuario u\n
                    JOIN rol r ON u.rol_codigo = r.codigo\n
                    WHERE u.id = ? AND u.contrasena = ?;
        """;
