...
public class LoteDAO {
    ...
    public List<Lote> listarLotesPaginado(int limit, int offset) {
        ...
        String sql = """
            SELECT 
                    ...
                    p.cantidad_asociada AS prod_cantidad,
                    p.estado AS prod_estado,
                    ...
                    pr.direccion AS prov_direccion, 
                    pr.contacto AS prov_contacto,
            
                    a.codigo AS alm_codigo, 
                    a.nombre AS alm_nombre, 
                    a.ubicacion AS alm_ubicacion
    ...
    public boolean actualizarUbicacionLote(String codigoLote, String nuevaUbicacionCodigo) {

        String sql = "UPDATE lote SET ubicacion_codigo=? WHERE codigo=?";

        try (Connection conn = Conexion.getConexion();
             PreparedStatement ps = conn.prepareStatement(sql)) {

            ps.setString(1, nuevaUbicacionCodigo);
            ...
            System.err.println("Error al actualizar ubicación de lote: " + e.getMessage());
            return false;
        }
    }
