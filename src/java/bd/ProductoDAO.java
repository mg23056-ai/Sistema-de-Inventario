...
public class ProductoDAO {
    ...
    public boolean actualizarCantidadAsociada(String codigo, int nuevaCantidad) {

        String sql = """
            UPDATE producto
            SET cantidad_asociada = ?
            WHERE codigo = ?
        """;
        ...
        try (Connection conn = Conexion.getConexion();
            ...
            System.err.println("Error al actualizar cantidad asociada: " + e.getMessage());
            return false;
        }
    }
