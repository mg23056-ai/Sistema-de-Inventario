        ...
        !codigo.isEmpty() && !almacenCodigo.isEmpty() && !nuevoAlmacenCodigo.isEmpty() && !costo.isEmpty()){
            ...
            try {
                if (loteDAO.existeLote(codigo)) {
                    ...
                    Almacen almacen = almacenDAO.obtenerAlmacenPorCodigo(nuevoAlmacenCodigo);
                    ...
                    if (prodSelect == null) {
                    ...
                    } else if (almacen.getCodigo().equals(almacenCodigo)) {
                        ...
                        boolean actualizado = loteDAO.actualizarUbicacionLote(codigo, almacen.getCodigo());
                        ...
                        if (actualizado) {
                            ...
                            MovimientoInventario mov = new MovimientoInventario(
                                    ...
                                    almacen.getCodigo(),                 // nuevaUbicacion   → se aplica N/A
...
<html>
    <head>
        ...
        <script>
            ...
            function seleccionarLote(codigo, productoId, ubicacion, cantidad) {
