                    ...
                    if (categoria == null) {
                        ...
                        if (!lotes.isEmpty()) {
                            ...
                            for (int i=0;i<lotes.size();i++) {
                                cantidadLote += lotes.get(i).getCantidad();
                            }
                            if(cantidadLote != cantidad){
                                anuncio = "<strong style='color:orange;'>Hay " + cantidadLote + " productos en sus lotes se definió así</strong>";
                                ...
                                if (ok) {
                                    mensaje = "<strong style='color:green;'>Producto actualizado correctamente. La cantidad asociada que ingresó difiere a la cantidad de lotes obtenida</strong>";
                                } else {
