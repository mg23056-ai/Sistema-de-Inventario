            ...
            try {
                ...
                if (productoDAO.existeProducto(codigo)) {
                    ...
                    if (categoria == null) {
                        ...
                        if(!loteDAO.listarLotePorProductoID(codigo).isEmpty()){
                            mensaje = "<strong style='color:orange;'>El producto tiene lotes, no se han hecho cambios</strong>";
                        }else{
