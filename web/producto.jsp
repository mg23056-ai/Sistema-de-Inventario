...
<%
    ...
    if ("guardar".equals(request.getParameter("cmd"))) {
        ...
        String precioTxt = request.getParameter("preciotxt");
        ...
        if (codigo != null && nombre != null && descripcion != null && precioTxt != null
                && categoriaCodigo != null && proveedorNit != null && estadoParam != null
                && !codigo.isEmpty() && !nombre.isEmpty() && !descripcion.isEmpty()
                && !precioTxt.isEmpty() && !categoriaCodigo.isEmpty() && !proveedorNit.isEmpty()) {
            ...
            try {
                ...
                mensaje = "<strong style='color:orange;'>El precio debe ser un número válido</strong>";
    ...
    if ("editar".equals(request.getParameter("cmd"))) {
        ...
        if (codigo != null && nombre != null && categoriaCodigo != null && descripcion != null
                && precioTxt != null && proveedorNit != null && estadoParam != null
                && !codigo.isEmpty() && !nombre.isEmpty() && !categoriaCodigo.isEmpty()
                && !precioTxt.isEmpty() && !proveedorNit.isEmpty()) {
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript">
            ...
            function editarProducto(codigo, nombre, descripcion, precio, categoria, proveedor, estado) {
                    ...
                    <table>
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="categorialst">
                                        ...
                                        %>
                                                <option value="">Error al cargar categorias</option>
                                        <%
                                            }
                                        %>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td><input name="preciotxt" type="text" placeholder="Ingrese un precio"/></td>
                            </tr>
                            <tr>
                                <td>Proveedor</td>
                                <td>
