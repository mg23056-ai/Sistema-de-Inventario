    ...
    if ("guardar".equals(request.getParameter("cmd"))) {
        ...
        if (codigo != null && productoCodigo != null && fechaIngresoTxt != null
            ...
            try {
                ...
                if (producto == null) {
                    mensaje = "<strong style='color:orange;'>El producto seleccionado no existe</strong>";
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript">
            ...
            function crearLote(codigoProducto) {
                const form = document.forms['crearLote'];
                const mensajeDiv = document.querySelector('.mensaje');

                // Se asigna el código del producto al campo correspondiente
                form.productotxt.value = codigoProducto;

                // Se asigna un código vacío al lote
                form.idtxt.value = "";

                // Cantidad inicial del lote = 0
                const cantidadInicial = 0;

                // Se puede mostrar en observaciones que aún no se ingresa cantidad
                form.observacionestxt.value = "Cantidad inicial: " + cantidadInicial;

                // Acción a realizar
                form.cmd.value = "guardar";

                mensajeDiv.innerHTML = "<strong style='color:green;'>Complete los datos para crear el lote</strong>";
            }
        </script>
        <style>
            body {
    ...
    <body>
        <nav class="topbar">
            ...
            <div class="topbar-links">
                ...
                <a href="transferir.jsp">Transferir Productos</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                    ...
                                                    onclick="document.forms['crearLote'].productotxt.value='<%= p.getCodigo() %>';
                                                             asignarAccion('guardar');">
                                                Crear Lote
                                            </button>
                                        </td>
                                    </tr>
