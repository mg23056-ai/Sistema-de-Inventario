        ...
        if (codigo != null && productoCodigo != null && fechaIngresoTxt != null
            ...
            try {
                ...
                if (producto == null) {
                    ...
                    if (ok) {
                        // Crear movimiento
                        String codigoMovimientoC = "MV" + UUID.randomUUID()
                            .toString()
                            .replace("-", "")
                            .substring(0, 8);
                                
                        TipoMovimiento tipo = TipoMovimientoDAO.buscarPorCodigo("TM09");
                        // Crear el movimiento usando el constructor COMPLETO
                        MovimientoInventario movRetiro = new MovimientoInventario(
                            codigoMovimientoC,     // codigo
                            tipo,                   // tipoMovimiento
...
<html lang="es">
    <head>
        ...
        <title>Crear Lote | RMT Systems</title>
